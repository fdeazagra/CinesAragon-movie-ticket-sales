...
public class Cine {
     ...
     * @param ciudad Ciudad donde se encuentra el cine.
    ...
    /**
     * Método toString de Cine.
     * 
     * @return Todos los atributos de la entidad concatenados en un String.
     */
    @Override
    public String toString() {
        return "Cine{" + "id=" + id + ", nombre=" + nombre + ", provincia=" 
                + provincia + ", pases=" + pases + ", telefono=" + telefono
                + ", ciudad=" + ciudad + ", pelicula_id=" + pelicula_id 
