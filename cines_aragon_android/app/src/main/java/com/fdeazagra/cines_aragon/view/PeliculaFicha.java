...
public class PeliculaFicha extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        btnTrailer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(getBaseContext(), PeliculasTrailer.class);
                intent.putExtra("valor", trailer);
    ...
    private void initComponents(){
        ...
        pases = (TextView) findViewById(R.id.pases);
    ...
    public void successBuscarPeliculas(ArrayList<Pelicula> lstPeliculas) {
        ...
        for (Pelicula pelicula: lstPeliculas){
            ...
            pases.setText("Pases: " + pelicula.getPases());
        }
